'''
Expected input: Name of Chicago community area a comma-separated list of
wards that intersect and a comma-sperated list of zipcodes.
...
zipcodes = os.environ.get('ZIPCODES','60639,60641,60647')
...
def feature_from_array(array, prop, value):
    ...
    try:
        ...
        if 'need more than 0 values' in str(e):
            ...
            raise ValueError('Error with features {0} "{1}"'.format(prop, value))
